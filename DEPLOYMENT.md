...
6. Login sebagai admin, daftarkan scanner di `/admin/devices`, lalu scan PDF417 kredensial satu kali dengan firmware 6.5.14. Verifikasi inventory lookup, heartbeat, scan, dan `/audit`.
...
4. CI menolak build bila versi dispatch ≠ `FIRMWARE_VERSION` di sketch (sekarang `6.5.14`).
