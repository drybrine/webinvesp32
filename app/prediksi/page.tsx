      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-10 space-y-8">
        <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between animate-fade-in-up">
          <div className="space-y-1">
            <p className="text-sm font-medium text-muted-foreground uppercase tracking-wider">Analitik</p>
            <h1 className="heading-1">Prediksi Stok</h1>
            <div className="flex items-center gap-2 pt-1">
              <p className="text-body">Linear regression untuk memperkirakan level stok ke depan.</p>
              {predictionSource && (
          ...
          <Link
            href="/"
            className="inline-flex items-center gap-1.5 self-start rounded-xl border border-border/60 bg-white px-4 py-2 text-sm font-medium text-foreground shadow-sm transition-all hover:bg-accent active:scale-[0.98]"
          >
