      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-10 space-y-8">
        ...
        <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between animate-fade-in-up">
          ...
          <div
            ...
            className={`
              inline-flex items-center gap-2 self-start md:self-auto px-4 py-2 rounded-full text-sm font-semibold border
              transition-all duration-300
              ${activeDeviceMode === "Manual"
                ? "bg-zinc-100 border-zinc-200 text-zinc-700"
                : activeDeviceMode === "Auto IN"
                  ? "bg-emerald-50 border-emerald-200 text-emerald-700 shadow-[0_2px_8px_-4px_rgba(16,185,129,0.25)]"
                  : "bg-amber-50 border-amber-200 text-amber-700 shadow-[0_2px_8px_-4px_rgba(245,158,11,0.25)]"
              }
            `}
          >
            <span className={
              "h-2 w-2 rounded-full inline-block animate-pulse " + (
                activeDeviceMode === "Manual" ? "bg-zinc-500"
