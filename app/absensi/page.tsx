...
export default function AbsensiPage() {
  ...
  const stats = useMemo(() => {
    ...
    const processCount = todayAttendance.filter(record => record.deviceId && record.deviceId !== 'manual').length
    return { total, unique, processCount }
  }, [todayAttendance])
      ...
      <div className="mobile-space-y">
        ...
        <div className="mobile-grid-stats mobile-gap mobile-margin animate-fade-in-up animation-delay-400">
          ...
          <Card className="glass-card card-hover shadow-medium hover:shadow-colored transition-all duration-500 group">
            ...
            <CardContent className="relative z-10 pt-0">
              <div className="space-y-2">
                <div className="text-2xl sm:text-3xl font-bold gradient-text">{stats.processCount}</div>
